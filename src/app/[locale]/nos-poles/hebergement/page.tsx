                ...
                cards: [
                  {
                    ...
                    profiles: ["RSSI", "DPO", "Expert RGPD/NIS2"],
                  ...
                  },
                  {
                    ...
                    profiles: ["DevSecOps", "DevNetOps", "Expert Réseau"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "DMZ Kubernetes : isolation réseau avancée par namespace", tags: ["Calico", "NetworkPolicy", "RBAC"], status: "active", cat: "cyber" },
                  ...
                  },
                  {
                    ...
                    profiles: ["DevSecOps", "Ingénieur SOC", "Expert K8s Security"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                  ...
                  },
                  {
                    ...
                    profiles: ["RSSI", "Auditeur technique", "DPO"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                ...
                cards: [
                  {
                    ...
                    profiles: ["Architecte Cloud", "DevOps Senior", "Ingénieur K8s"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                  ...
                  },
                  {
                    ...
                    profiles: ["Architecte Cloud", "DevOps", "Lead Technique"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    articles: [
                  ...
                  },
                  {
                    ...
                    profiles: ["Architecte Cloud", "RSSI", "DPO"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    articles: [
                      { title: "Hébergement souverain : pourquoi nous avons investi dans notre propre infrastructure physique", category: "DevOps", href: "/actualite/hebergement-souverain-infra-physique" },
                  ...
                  },
                  {
                    ...
                    profiles: ["SRE", "DevOps", "FinOps Analyst"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                ...
                cards: [
                  {
                    ...
                    profiles: ["Ingénieur Infrastructure", "DevNetOps"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    articles: [
                      { title: "Hébergement souverain : pourquoi nous avons investi dans notre propre infrastructure physique", category: "DevOps", href: "/actualite/hebergement-souverain-infra-physique" },
                  ...
                  },
                  {
                    ...
                    profiles: ["DevNetOps", "Ingénieur Réseau", "Expert Fortigate"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "DMZ Kubernetes : isolation réseau avancée par namespace", tags: ["Calico", "NetworkPolicy", "RBAC"], status: "active", cat: "cyber" },
                  ...
                  },
                  {
                    ...
                    profiles: ["Ingénieur Virtualisation", "DevOps", "SRE"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "Proxmox multi-zone mutualisé : gestion et isolation", tags: ["Proxmox", "TrueNAS", "VLAN"], status: "active", cat: "infra" },
                  ...
                  },
                  {
                    ...
                    profiles: ["Architecte Cloud", "DevNetOps", "Lead Technique"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "Kubernetes HA multi-zoning : architecture et opérations", tags: ["K8s", "HA", "multi-zone"], status: "active", cat: "infra" },
                ...
                cards: [
                  {
                    ...
                    profiles: ["DevOps Senior", "DevSecOps", "Ingénieur K8s"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                  ...
                  },
                  {
                    ...
                    profiles: ["Ingénieur MCO", "Chef de projet", "DevOps"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "Self-healing IA : auto-remédiation des incidents avec N8N", tags: ["N8N", "IA", "Prometheus"], status: "done", cat: "devops" },
                  ...
                  },
                  {
                    ...
                    profiles: ["SRE", "DevOps", "Ingénieur Monitoring"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    labItems: [
                      { title: "Monitoring multi-cluster : performance et scalabilité", tags: ["Thanos", "Prometheus", "Grafana"], status: "active", cat: "devops" },
                  ...
                  },
                  {
                    ...
                    profiles: ["Chef de projet", "RSSI", "Responsable Qualité"],
                    ctaLabel: "Nous contacter",
                    ctaHref: "/contact",
                    articles: [
                      { title: "CI/CD avec GitLab et ArgoCD : comment on industrialise nos déploiements", category: "DevOps", href: "/actualite/cicd-gitlab-argocd-industrialisation" },
